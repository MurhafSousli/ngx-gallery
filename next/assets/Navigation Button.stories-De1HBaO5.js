import{n as e,r as t}from"./rolldown-runtime-D_-wTCJc.js";import{i as n,n as r,o as i,t as a}from"./preview-kKzLW__x.js";import{a as o,i as s,n as c,r as l,v as u,y as d}from"./pixabay.service-BBp6Zvkd.js";var f=t({CustomNavPositionExample:()=>h,CustomNavTemplateExample:()=>m,__namedExportsOrder:()=>g}),p,m,h,g;function init_Navigation_Button_stories(){return(init_Navigation_Button_stories=e((()=>{a(),n(),o(),d(),l(),p=r.meta({component:u,decorators:[i({imports:[s]})],args:{},argTypes:{type:{name:`galleryNavButton`,table:{defaultValue:{summary:null}}}}}),m=p.story({tags:[`!dev`],loaders:[async()=>({items:await c()})],render:(e,{loaded:{items:t}})=>({props:{...e,items:t},template:`
    ...
    `})}),g=[`CustomNavTemplateExample`,`CustomNavPositionExample`],m.input.parameters={...m.input.parameters,docs:{...m.input.parameters?.docs,source:{originalSource:`meta.story({
  tags: ['!dev'],
  loaders: [async () => ({
...
})`,...h.input.parameters?.docs?.source}}}})))()}export{init_Navigation_Button_stories as i,m as n,f as r,h as t};