import{n as e,r as t}from"./rolldown-runtime-D_-wTCJc.js";import{i as n,n as r,o as i,t as a}from"./preview-kKzLW__x.js";import{a as o,f as s,i as c,n as l,p as u,r as d}from"./pixabay.service-BBp6Zvkd.js";var f=t({CenterAlingmentExample:()=>m,EndAlingmentExample:()=>g,StartAlingmentExample:()=>h,__namedExportsOrder:()=>_}),p,m,h,g,_;function init_Alignment_stories(){return(init_Alignment_stories=e((()=>{a(),n(),u(),o(),d(),p=r.meta({title:`Documentations/Alignment`,component:s,decorators:[i({imports:[c]})]}),m=p.story({tags:[`!dev`],loaders:[async()=>({items:await l()})],render:(e,{loaded:{items:t}})=>({props:{...e,items:t},template:`
    ...
    `})}),_=[`CenterAlingmentExample`,`StartAlingmentExample`,`EndAlingmentExample`],m.input.parameters={...m.input.parameters,docs:{...m.input.parameters?.docs,source:{originalSource:`meta.story({
  tags: ['!dev'],
  loaders: [async () => ({
...
})`,...g.input.parameters?.docs?.source}}}})))()}export{init_Alignment_stories as a,h as i,m as n,g as r,f as t};