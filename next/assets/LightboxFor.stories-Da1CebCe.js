import{n as e,r as t}from"./rolldown-runtime-D_-wTCJc.js";import{i as n,n as r,o as i,t as a}from"./preview-kKzLW__x.js";import{r as o,t as s}from"./pixabay.service-BBp6Zvkd.js";import{i as c,n as l,r as u,t as d}from"./lightbox.module-36Aw8spS.js";var f=t({LightboxForGalleryExample:()=>h,LightboxForGridExample:()=>m,__namedExportsOrder:()=>g}),p,m,h,g;function init_LightboxFor_stories(){return(init_LightboxFor_stories=e((()=>{a(),n(),l(),c(),o(),p=r.meta({title:`Addons/Lightbox`,component:u,decorators:[i({imports:[d]})]}),m=p.story({name:`LightboxForGrid`,loaders:[async()=>({items:await s(`Nature`)})],render:(e,{loaded:{items:t}})=>({props:{...e,items:t},template:`
    ...
    `})}),g=[`LightboxForGridExample`,`LightboxForGalleryExample`],m.input.parameters={...m.input.parameters,docs:{...m.input.parameters?.docs,source:{originalSource:`meta.story({
...
})`,...h.input.parameters?.docs?.source}}}})))()}export{init_LightboxFor_stories as i,m as n,f as r,h as t};