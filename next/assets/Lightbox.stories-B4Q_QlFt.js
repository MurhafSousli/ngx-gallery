import{n as e,r as t}from"./rolldown-runtime-D_-wTCJc.js";import{i as n,n as r,o as i,t as a}from"./preview-kKzLW__x.js";import{r as o,t as s}from"./pixabay.service-BBp6Zvkd.js";import{a as c,n as l,o as u,t as d}from"./lightbox.module-36Aw8spS.js";var f=t({LightboxExample:()=>m,__namedExportsOrder:()=>h}),p,m,h;function init_Lightbox_stories(){return(init_Lightbox_stories=e((()=>{a(),n(),l(),u(),o(),p=r.meta({title:`Addons/Lightbox`,component:c,decorators:[i({imports:[d]})]}),m=p.story({name:`Lightbox`,loaders:[async()=>({items:await s(`Boat`)})],render:(e,{loaded:{items:t}})=>({props:{...e,items:t},template:`
    ...
    `]})]}),h=[`LightboxExample`],m.input.parameters={...m.input.parameters,docs:{...m.input.parameters?.docs,source:{originalSource:`meta.story({
  name: 'Lightbox',
  loaders: [async () => ({
...
})`,...m.input.parameters?.docs?.source}}}})))()}export{f as n,init_Lightbox_stories as r,m as t};