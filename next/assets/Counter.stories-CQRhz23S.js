import{n as e,r as t}from"./rolldown-runtime-D_-wTCJc.js";import{i as n,n as r,o as i,t as a}from"./preview-kKzLW__x.js";import{a as o,c as s,i as c,l,n as u,r as d}from"./pixabay.service-BBp6Zvkd.js";var f=t({Counter:()=>m,CustomCounter:()=>h,__namedExportsOrder:()=>g}),p,m,h,g;function init_Counter_stories(){return(init_Counter_stories=e((()=>{a(),n(),l(),o(),d(),p=r.meta({title:`Documentations/Counter`,component:s,decorators:[i({imports:[c]})],args:{align:`top`},argTypes:{align:{control:`radio`,options:[`top`,`bottom`],table:{type:{summary:`'top' | 'bottom'`},defaultValue:{summary:`'top'`}}}}}),m=p.story({loaders:[async()=>({items:await u()})],render:(e,{loaded:{items:t}})=>({props:{...e,items:t},template:`
    ...
    `]})}),g=[`Counter`,`CustomCounter`],m.input.parameters={...m.input.parameters,docs:{...m.input.parameters?.docs,source:{originalSource:`meta.story({
  loaders: [async () => ({
...
})`,...h.input.parameters?.docs?.source}}}})))()}export{init_Counter_stories as i,f as n,h as r,m as t};