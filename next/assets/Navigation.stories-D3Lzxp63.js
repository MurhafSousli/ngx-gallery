import{n as e,r as t}from"./rolldown-runtime-D_-wTCJc.js";import{i as n,n as r,o as i,t as a}from"./preview-kKzLW__x.js";import{_ as o,a as s,g as c,i as l,n as u,r as d}from"./pixabay.service-BBp6Zvkd.js";var f=t({NavigationExample:()=>m,OutsideNavExample:()=>h,__namedExportsOrder:()=>g}),p,m,h,g;function init_Navigation_stories(){return(init_Navigation_stories=e((()=>{a(),n(),s(),o(),d(),p=r.meta({title:`Documentations/Navigation`,component:c,decorators:[i({imports:[l]})],args:{showDisabledButtons:!1,outside:!1},argTypes:{outside:{control:`boolean`,table:{defaultValue:{summary:`false`}}},showDisabledButtons:{control:`boolean`,table:{defaultValue:{summary:`false`}}}}}),m=p.story({name:`Navigation`,loaders:[async()=>({items:await u()})],render:(e,{loaded:{items:t}})=>({props:{...e,items:t},template:`
    ...
    `})}),g=[`NavigationExample`,`OutsideNavExample`],m.input.parameters={...m.input.parameters,docs:{...m.input.parameters?.docs,source:{originalSource:`meta.story({
  name: 'Navigation',
  loaders: [async () => ({
...
})`,...h.input.parameters?.docs?.source}}}})))()}export{init_Navigation_stories as i,f as n,h as r,m as t};