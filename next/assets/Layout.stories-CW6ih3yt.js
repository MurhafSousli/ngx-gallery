import{n as e,r as t}from"./rolldown-runtime-D_-wTCJc.js";import{i as n,n as r,o as i,t as a}from"./preview-kKzLW__x.js";import{a as o,f as s,i as c,n as l,p as u,r as d,t as f}from"./pixabay.service-BBp6Zvkd.js";var p=t({AutoItemSizeExample:()=>y,DefaultItemsPerViewExample:()=>h,FixedItemSizeExample:()=>v,FrictionItemsPerViewExample:()=>_,MutlipleItemsPerViewExample:()=>g,__namedExportsOrder:()=>b}),m,h,g,_,v,y,b;function init_Layout_stories(){return(init_Layout_stories=e((()=>{a(),n(),u(),o(),d(),m=r.meta({title:`Documentations/Layout`,component:s,decorators:[i({imports:[c]})]}),h=m.story({tags:[`!dev`],loaders:[async()=>({items:await l()})],render:(e,{loaded:{items:t}})=>({props:{...e,items:t},template:`
    ...
    `})}),b=[`DefaultItemsPerViewExample`,`MutlipleItemsPerViewExample`,`FrictionItemsPerViewExample`,`FixedItemSizeExample`,`AutoItemSizeExample`],h.input.parameters={...h.input.parameters,docs:{...h.input.parameters?.docs,source:{originalSource:`meta.story({
  tags: ['!dev'],
  loaders: [async () => ({
...
})`,...y.input.parameters?.docs?.source}}}})))()}export{p as a,_ as i,h as n,g as o,v as r,init_Layout_stories as s,y as t};